...
class Preferences {
  static delaySettings() {
    ...
    try {
      ...
      settingsTab.querySelector('.title').textContent = this.defS.Settings[
        'tab-title'
      ];
  ...
  static applyPlaceholders() {
    ...
    if (searchBarPlaceholder) {
      searchBarPlaceholder.textContent = this.defS.Settings.keymaps[
    ...
    if (searchBarPlaceholder) {
      searchBarPlaceholder.textContent = this.defS.Settings.install[
