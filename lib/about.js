...
export default class About {
  ...
  static updateAbout() {
    ...
    about = document.querySelector('div[class="pane-item native-key-bindings about"]')
    if (about === null) {
      return
    }
    if (about.getAttribute('data-localized') !== 'true') {
      ...
      if (updatesGroup !== null && updatesGroup.offsetParent !== null) { // element visibility
        ...
        if (appUpToDate !== null) { // when atom is up to date (tested)
          updatesGroup.querySelector('span.about-updates-label.is-strong').textContent = upToDate
