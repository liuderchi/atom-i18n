...
export default class About {
  ...
  static updateAbout() {
    ...
    aboutTab.querySelector(
      'div[class="title icon icon-info"]'
    ).textContent = this.defA.About.tabTitle;
    ...
    if (about.getAttribute("data-localized") !== "true") {
      ...
      if (updatesGroup !== null && updatesGroup.offsetParent !== null) {
        ...
        updatesGroup.querySelector(
          ".about-auto-updates span"
        ).textContent = automaticDownloadUpdates;
        if (updatesGroup.querySelector("span.about-updates-label") !== null) {
          updatesGroup.querySelector(
            "span.about-updates-label"
          ).textContent = newUpdate;
        }
        if (
        ...
        if (appUpToDate !== null) {
          ...
          updatesGroup.querySelector(
            "span.about-updates-label"
          ).textContent = checkingForUpdates; // when have update, need to restart and install (not tested)
        } else {
