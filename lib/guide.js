...
export default class Guide {
  // private: get the pane of "Welcome Guide"
  static getGuidePane() {
  ...
  // private: update "GuideView" by replacing with localized strings.
  static updateGuide(pane) {
    ...
    if (guide.getAttribute('data-localized') !== 'true') {
      ...
      for (let card of cardGroup) {
        ...
        let deatil = this.getFirstElementsByClassName(card, 'welcome-detail')
        let note = this.getFirstElementsByClassName(card, 'welcome-note')
